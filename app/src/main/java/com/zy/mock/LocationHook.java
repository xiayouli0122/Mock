        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            XposedHelpers.findAndHookMethod("android.telephony.TelephonyManager", classLoader,
                    "getPhoneCount", new XC_MethodHook() {
                        @Override
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            XposedBridge.log("afterHookedMethod =====1111===getPhoneCount");
                            param.setResult(1);
                        }
                    });
        }
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            XposedHelpers.findAndHookMethod("android.telephony.TelephonyManager", classLoader,
                    "getNeighboringCellInfo", new XC_MethodHook() {
                        @Override
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            XposedBridge.log("afterHookedMethod =====1111===getNeighboringCellInfo");
                            //获取周围基站信息
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            XposedHelpers.findAndHookMethod("android.telephony.TelephonyManager", classLoader,
                    "getAllCellInfo", new XC_MethodHook() {
                        @Override
                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                            XposedBridge.log("afterHookedMethod =====1111===getAllCellInfo");
                            //返回所能监测到的基站信息
            ...
            XposedHelpers.findAndHookMethod("android.telephony.PhoneStateListener", classLoader,
                    "onCellInfoChanged", List.class, new XC_MethodHook() {
                        ...
                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                            XposedBridge.log("afterHookedMethod =====1111===onCellInfoChanged");
                              param.setResult(null);
//                            param.setResult(getCell(460, 0, lac, cid, 0,0));
                        }
                    });
...
//            @Override
//            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
//                XposedBridge.log("afterHookedMethod =====1111===getScanResults");
//                param.setResult(new ArrayList<>());
//            }
//        });
        ...
        XposedHelpers.findAndHookMethod("android.location.Location", classLoader, "getLatitude", new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param)
                ...
                XSharedPreferences xsp = new XSharedPreferences(this.getClass().getPackage().getName(), "prefs");
                double latitude = Double.valueOf(xsp.getString("lan","39.99"))+ (double) new Random().nextInt(1000) / 1000000;
                XposedBridge.log("getLatitude=" + latitude);
        ...
        XposedHelpers.findAndHookMethod("android.location.Location", classLoader, "getLongitude", new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param)
                ...
                super.beforeHookedMethod(param);
                XSharedPreferences xsp = new XSharedPreferences(this.getClass().getPackage().getName(), "prefs");
                double longitude = Double.valueOf(xsp.getString("lon","116.31"))+ (double) new Random().nextInt(1000) / 1000000;
                XposedBridge.log("getLongitude=" + longitude);
        ...
        XposedHelpers.findAndHookMethod("android.net.wifi.WifiManager", classLoader, "getWifiState", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                XposedBridge.log("afterHookedMethod =====1111===getWifiState");
                param.setResult(1);
            }
        });
        ...
        XposedHelpers.findAndHookMethod("android.net.wifi.WifiManager", classLoader, "isWifiEnabled", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                XposedBridge.log("afterHookedMethod =====1111===isWifiEnabled");
        ...
        XposedHelpers.findAndHookMethod("android.net.wifi.WifiInfo", classLoader, "getMacAddress", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                XposedBridge.log("afterHookedMethod =====1111===getMacAddress");
...
//        });
        ...
        XposedHelpers.findAndHookMethod(LocationManager.class, "getLastLocation", new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                double latitude = Double.valueOf(xsp.getString("lan","39.99"))+ (double) new Random().nextInt(1000) / 1000000 ;
                double longitude = Double.valueOf(xsp.getString("lon","116.31"))+ (double) new Random().nextInt(1000) / 1000000;
                XposedBridge.log("getLastLocation.latitude:" + latitude + ",longitude:" + longitude);
                location.setLatitude(latitude);
                location.setLongitude(longitude);
                location.setAccuracy(100.f);
...
//                }
        ...
        XposedHelpers.findAndHookMethod(LocationManager.class, "getLastKnownLocation", String.class, new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                double latitude = Double.valueOf(xsp.getString("lan","39.99"))+ (double) new Random().nextInt(1000) / 1000000;
                double longitude = Double.valueOf(xsp.getString("lon","116.31"))+ (double) new Random().nextInt(1000) / 1000000;
                XposedBridge.log("getLastKnownLocation.latitude:" + latitude + ",longitude:" + longitude);
                location.setLatitude(latitude);
                location.setLongitude(longitude);
                location.setAccuracy(100.f);
//                location.setAccuracy(Criteria.ACCURACY_HIGH);
                ...
                XposedBridge.hookMethod(method, new XC_MethodHook() {
                    ...
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        if (param.args.length >= 4 && (param.args[3] instanceof LocationListener)) {
                            ...
                            double latitude = Double.valueOf(xsp.getString("lan"," 39.99"))+ (double) new Random().nextInt(1000) / 1000000;
                            double longitude = Double.valueOf(xsp.getString("lon","116.31"))+ (double) new Random().nextInt(1000) / 1000000;
                            XposedBridge.log("requestLocationUpdates.latitude:" + latitude + ",longitude:" + longitude);
                            location.setLatitude(latitude);
                            location.setLongitude(longitude);
                            location.setAccuracy(10.f);
//                            location.setAccuracy(Criteria.ACCURACY_HIGH);
//                            location.setTime(System.currentTimeMillis());
                            location.setTime(0);
//                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
...
//                            }
                            ...
                            try {
                                if (m != null) {
                                    ...
                                    XposedBridge.log("调用onLocationChanged");
                                    XposedBridge.log("调用onLocationChanged:"  + ",经度" + latitude + ",纬度" + longitude);
                                }
                            } catch (Exception e) {
                                XposedBridge.log(e);
                            }
                        ...
                        if (param.args.length >= 3 && (param.args[1] instanceof LocationListener)) {
                            ...
                            try {
                                if (m != null) {
                                    ...
                                    double latitude = Double.valueOf(xsp.getString("lan","39.99"))+ (double) new Random().nextInt(1000) / 1000000;
                                    double longitude = Double.valueOf(xsp.getString("lon","116.31"))+ (double) new Random().nextInt(1000) / 1000000;
                                    XposedBridge.log("requestSingleUpdate.latitude:" + latitude + ",longitude:" + longitude);
                                    location.setLatitude(latitude);
                                    location.setLongitude(longitude);
                                    location.setAccuracy(100.f);
//                                    location.setTime(System.currentTimeMillis());
...
//                                    }
                                    m.invoke(ll, location);
                                    XposedBridge.log("onLocationChanged  :"  + ",经度" + latitude + ",纬度" + longitude);
                                }
                            } catch (Exception e) {
                                XposedBridge.log(e);
                            }
